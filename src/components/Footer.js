        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="flex space-x-4 mt-2">
              ...
              <a href="https://facebook.com" className="text-gray-300 hover:text-white" aria-label="Twitter">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="md:col-span-2 flex md:justify-end">
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li>
                  <span className="block">Telefon: <a href="tel:+905551112233" className="hover:text-white">+90 555 111 22 33</a></span>
                </li>
                <li>
                  <span className="block">E-posta: <a href="mailto:info@bilenden.com" className="hover:text-white">info@bilenden.com</a></span>
                </li>
                <li>
