    ...
    <div className="py-16 bg-[#232323] text-[#4ecb8f] min-h-screen">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-[#f87171] mb-6">
        ...
        {/* Our Fields Section */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-[#f87171] mb-8 text-center">
            Alanlarımız
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {fields.map((field, idx) => (
              <div key={idx} className="bg-white bg-opacity-20 rounded-lg shadow p-6">
                <h3 className="text-xl font-semibold text-[#f87171] mb-2">
                  {field.title}
                </h3>
                <p className="text-[#a7f3d0]">{field.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center mt-16">
          <h2 className="text-2xl font-bold text-[#f87171] mb-4">
            Uzmanlık Alanlarımız Hakkında Daha Fazla Bilgi Almak İster misiniz?
          </h2>
          <p className="text-[#a7f3d0] mb-6">
            Alanlarımızla ilgili detaylı bilgi veya bilirkişi raporu talebi için
            bizimle iletişime geçebilirsiniz.
          </p>
          <button className="bg-[#4ecb8f] text-[#232323] px-8 py-3 rounded-lg hover:bg-[#38b27e] transition-colors font-semibold">
            İletişim Formu
          </button>
        </div>
      </div>
